      ...
      <div className="filters">
        <div className="select-container">
          ...
          >
            ...
            <option
              value="option2"
              id={`${selected.option2 ? "selected" : ""}`}
            >
              Option 2
            </option>
            <option
              value="option3"
              id={`${selected.option3 ? "selected" : ""}`}
            >
              Option 3
            </option>
          </Select>
          ...
          >
            <option
              value="option4"
              id={`${selected.option4 ? "selected" : ""}`}
            >
              Option 4
            </option>
            <option
              value="option5"
              id={`${selected.option5 ? "selected" : ""}`}
            >
              Option 5
            </option>
            <option
              value="option6"
              id={`${selected.option6 ? "selected" : ""}`}
            >
              Option 6
            </option>
          </Select>
